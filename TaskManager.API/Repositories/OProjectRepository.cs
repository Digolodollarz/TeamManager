...
//            if (currentUserId == null) this.currentUserId = "diggie";
//        }
...
//        public int CreateSkill(string skillName)
//        {
//            ctx.Skills.Add(new Skill {Name = skillName});
//            return ctx.SaveChanges();
//        }

//        public Project FindProjectByName(string projectName)
//        {
//            return ctx.Projects.FirstOrDefault(p => p.Name.Equals(projectName));
//        }
//    }
